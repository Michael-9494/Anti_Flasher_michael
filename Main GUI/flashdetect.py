...
def Start_detect(file_Path,q,self):
    ...
    functions.Save_Data(self.CurrURL,timeRGB, freqenciesFoundRGB, powerSpectrumRGB,mainTS_RGB,mainTS_cluster_each_colour_and_find_best,time_stampsRGB,time_frames )
